...
?>
<div class="wmc-tp wmc-tp--list" itemscope itemtype="https://schema.org/Organization">
<?php foreach ($groups as $list):
    ...
    <article class="wmc-tp-card" itemscope itemtype="https://schema.org/Review">
        ...
        <?php if (!empty($main['date'])): ?>
            <meta itemprop="datePublished" content="<?php echo esc_attr($main['date']); ?>">
        <?php endif; ?>
        ...
        <?php if (!empty($main['title'])): ?>
            <h3 class="wmc-tp-title"><?php echo esc_html($main['title']); ?></h3>
        <?php endif; ?>
        <?php if (!empty($main['text'])): ?>
            <p class="wmc-tp-text" itemprop="reviewBody"><?php echo esc_html($main['text']); ?></p>
        <?php endif; ?>
            ...
            <?php foreach ($older as $or): ?>
                <div class="wmc-tp-older" itemscope itemtype="https://schema.org/Review">
                    ...
                    <?php if (!empty($or['date'])): ?>
                        <meta itemprop="datePublished" content="<?php echo esc_attr($or['date']); ?>">
                    <?php endif; ?>
                    <div itemprop="reviewRating" itemscope itemtype="https://schema.org/Rating">
